...
function Documents() {
  ...
  const updatePage = (event: React.ChangeEvent<unknown>, value: number) => {
    ...
    dispatch(resourcesList("seminars", saved, search, reading, read, unread));
  };
  ...
  React.useEffect(() => {
    ...
    dispatch(
      resourcesList("seminars", saved, search, reading, read, unread)
    );
        ...
        <React.Fragment>
          <div className={classes.titleAndSearchContainer}>
            <div className={classes.title}>
              <ScreenTitle title="Seminars" />
            </div>
            <div className={classes.searchWithFilter}>
              <SearchComponent type={"seminars"} />
