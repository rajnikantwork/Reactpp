...
function EditTemplate({ setOpen }: Props) {
  ...
  const { singleTemplateData } = useSelector(
    (state: ReducersModal) => state.templateDetailReducer
  );
  ...
  //Code to get the Initial data from api //
  React.useEffect(() => {
    setTitle(singleTemplateData.title);
  ...
  //Code to count words in template //
  const countWords = () => {
  ...
  //Code to accumulate all form data and send to API //
